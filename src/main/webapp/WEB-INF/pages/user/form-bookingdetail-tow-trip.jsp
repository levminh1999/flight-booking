                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="col-lg-12 p-t-20">
                                        ...
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            ...
                                            <label style="margin-top: -15px" for="seat" class="mdl-textfield__label">Hạng ghế Lượt đi</label>
                                            <span class="form-message" style="color: #d50000;font-size: 12px"></span>                                      
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-t-20"> 
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            ...
                                            <label for="seat" style="margin-top: -15px" class="mdl-textfield__label">Ghế lượt đi</label>
                                            <span class="form-message" style="color: #d50000;font-size: 12px"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 p-t-20">
                                        <div id="seat-price" class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            ...
                                            <label class = "mdl-textfield__label" for = "id-price">Giá ghế lượt đi</label>                                   
