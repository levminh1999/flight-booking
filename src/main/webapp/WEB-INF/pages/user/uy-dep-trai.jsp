                        ...
                        <div class="card-box">
                            <div class="card-head">
                                <c:if test="${loopForm == 0}">
                                    <header>Nhập Thông Tin Người Đặt Vé</header>

                                </c:if>
                                <c:if test="${loopForm != 0}">
                                    <header>Nhập Thông Tin Hành Khách ${loopForm}</header>
                                    </c:if>
                            ...
                            <c:if test="${loopForm == 0}">
                                <mvc:form id="add-bookingdetail-form" action="${pageContext.request.contextPath}/booking-info" method="get" modelAttribute="bookingInfo">
                            ...
                            <c:if test="${loopForm != 0}">
                                ...
                                <mvc:form id="add-bookingdetail-form" action="${pageContext.request.contextPath}/select-seat" method="get" modelAttribute="bookingdetail">
                                    <div class="card-body row">
                                        <div class="col-lg-6 p-t-20"> 
                                            <div class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            ...
                                            <div class="custom iqdropdown mdl-textfield__input" style="border: none;padding-left: 0px">
                                                ...
                                                <div class="iqdropdown-menu" style="overflow-y: auto;height: 250px">
                                                        <div
                                                            ...
                                                            >
                                                            <div>
                                                                <p class="iqdropdown-item">Bánh Mì</p>
                                                        ...
                                                        <div
                                                            ...
                                                            >
                                                            <div>
                                                                <p class="iqdropdown-item">Cà phê</p>
                                                         ...
                                                         <div
                                                            ...
                                                            >
                                                            <div>
                                                                <p class="iqdropdown-item">Già rán</p>
                                                        ...
                                                        <div
                                                            ...
                                                            >
                                                            <div>
                                                                <p class="iqdropdown-item">Piza</p>
                                        ...
                                        <div class="col-lg-12 p-t-20">
                                            <div id="seat-price" class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input name="priceSeat" id="id-price" disabled style="color: black" class = "mdl-textfield__input" type = "text" value="" >
