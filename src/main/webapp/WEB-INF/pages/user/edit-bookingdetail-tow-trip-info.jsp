                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box">
                            ...
                            <mvc:form id="edit-bookingdetail-form" action="${pageContext.request.contextPath}/submit-edit-bookingdetail-tow-trip-info" method="get" modelAttribute="bookingDetailEdit">
                                <div class="card-body row">
                                    ...
                                    <div class="col-lg-12 p-t-20">
                                        <div id = "price-service" class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input  class = "mdl-textfield__input" type = "text" value="${totalServiceOfBookingDetail}">
                                    ...
                                    <div class="col-lg-12 p-t-20">
                                            ...
                                            <div class="custom2 iqdropdown mdl-textfield__input" style="border: none;padding-left: 0px">
                                                ...
                                                <div class="iqdropdown-menu" style="overflow-y: auto;height: 250px">
                                                        ...
                                                        <c:forEach var="sv2" items="${bookingArrivalDetailEdit.serviceBookings}">
                                                        
                                                                <div
                                                            class="iqdropdown-menu-option"
                                                            data-id="${sv2.service.id}"
                                                            data-defaultcount="${sv2.quantity}"
                                                            data-mincount="0"
                                                            >
                                                            <div>
                                                                <p class="iqdropdown-item">${sv2.service.name} - <fmt:formatNumber type = "number" 
                                                                   maxFractionDigits = "0" value = "${sv2.service.price}" /> VND</p>

                                                            </div>
                                                        </div>
                                                
                                                        </c:forEach>
                                                    <c:forEach var="newService2" items="${getNewServiceArrival}">
                                                        <div
                                                            class="iqdropdown-menu-option"
                                                            data-id="${newService2.value.id}"
                                                            data-defaultcount="0"
                                                            data-mincount="0"
                                                            >
                                                            <div>
                                                                <p class="iqdropdown-item">${newService2.value.name} - <fmt:formatNumber type = "number" 
                                                                   maxFractionDigits = "0" value = "${newService2.value.price}" /> VND</p>
                                        ...
                                        <div class="col-lg-12 p-t-20">
                                            <div id = "price-service-arrival" class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                                <input  class = "mdl-textfield__input" type = "text" value="<fmt:formatNumber type = "number" 
                                                                   maxFractionDigits = "0" value = "${totalServiceOfBookingDetailArrival}" /> VND ">
                                                <label class = "mdl-textfield__label" for = "price-service">Giá dịch vụ lượt về</label>                                   
                                                <span class="form-message" style="color: #d50000;font-size: 12px"></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-6 p-t-20"> 
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <select name="seatTypeNameArrival" id="seat-type-arrival-edit" class="mdl-textfield__input" >
                                                <option></option>
                                                <c:forEach var="resultsMapArrival" items="${resultsMapArrival}">
                                                    <c:if test="${resultsMapArrival.key == bookingArrivalDetailEdit.seatType}">
                                                        <option selected="" value="${resultsMapArrival.value}">${resultsMapArrival.key}</option>
                                                    </c:if>
                                                    <c:if test="${resultsMapArrival.key != bookingArrivalDetailEdit.seatType}">
                                            ...
                                            <label style="margin-top: -15px" for="seat-type-arrival" class="mdl-textfield__label">Hạng ghế Lượt về</label>
                                            <span class="form-message" style="color: #d50000;font-size: 12px"></span>                                      
                                        </div>
                                    </div>
                                    <div class="col-lg-6 p-t-20"> 
                                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
                                            <select id="seat-arrival" name="seatArrival" class="mdl-textfield__input" >
                                                <option selected>${bookingArrivalDetailEdit.seat.number}</option>

                                            </select>
                                            <label for="seat-arrival" style="margin-top: -15px" class="mdl-textfield__label">Ghế lượt về</label>
                                            <span class="form-message" style="color: #d50000;font-size: 12px"></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 p-t-20">
                                        <div id="seat-price-arrival" class = "mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                                            <input id="id-price-arrival" disabled style="color: black" class = "mdl-textfield__input" type = "text" value="<fmt:formatNumber type = "number" maxFractionDigits = "0" value = "${priceSeatArrival}" /> VND" >
                                            <label class = "mdl-textfield__label" for = "id-price-arrival">Giá ghế lượt về</label>                                   
        ...
        <script>
                                        ...
                                        Validator({
                                            ...
                                            rules: [
                                                ...
                                                Validator.isSeatTypeArrival('#seat-type-arrival-edit')
                                            ]
                                        });
        ...
        <script type="text/javascript">
                                    $(document).ready(function () {
                                        ...
                                        $(".custom").iqDropdown({
                                            minItems: 0,
                                            maxItems: 20,
                                            selectionText: "dịch vụ lượt đi",
                                            textPlural: "dịch vụ lượt đi",
                                        ...
                                        $(".custom2").iqDropdown({
                                            minItems: 0,
                                            maxItems: 20,
                                            selectionText: "dịch vụ lượt về",
                                            textPlural: "dịch vụ lượt về",
                                            onChange: function (id, count, totalItems) {
                                                $.ajax({
